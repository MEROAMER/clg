...
- required components to establish communication link? (sender, receiver, medium, message, protocol)![[Pasted image 20251019064202.png]]

- Data flow: 
	- Simplex:
		one direction all the time, ex: keyboard->CPU, TV or Radio.
		![[Pasted image 20251019064617.png]]
	- half-dup:
		one direction/time, not simultaneously, ex: walkie talkie.
		![[Pasted image 20251019064753.png]]
	- full-dup:
		both direction all time, ex: phone
		![[Pasted image 20251019065017.png]]
...
- Internetworking Devices:
	...
	![[Pasted image 20251019070233.png]]

	![[Pasted image 20251019071113.png]]
	![[Pasted image 20251019071335.png]]
	OSI Physical layer:
	1. Hub
